    ...
    <section className="min-h-screen flex flex-col justify-center pt-20">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mb-4 animate-fade-in opacity-0" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
          <h4 className="text-primary font-mono tracking-wider">Hello, my name is</h4>
        </div>
        
        <div className="mb-6 animate-fade-in opacity-0" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
          <h1 className="text-4xl md:text-7xl font-bold leading-tight">
            <span className="text-gradient">CS Student.</span><br />
            <span className="mt-2 block">Developer & Designer.</span>
          </h1>
        </div>
        
        <div className="mb-8 max-w-xl animate-fade-in opacity-0" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
          <p className="text-muted-foreground text-lg">
            I'm a final year computer science student passionate about creating elegant
            solutions through clean, efficient code. Specializing in web development and
            machine learning.
          </p>
        </div>
